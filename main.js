...
function positionSuccess({cords}){
    getWeather(cords.latitude,cords.longitude,Intl.DateTimeFormat().resolvedOptions().timeZone)
    .then(renderWeather).catch(e => {console.log(e)
...
function getIconUrl(iconCode) {
    return `public_newIcons/${ICON_MAP.get(iconCode)}.svg`
}
